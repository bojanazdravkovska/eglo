      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <span className="text-gray-900">Working at EGLO</span>
          </nav>
        </div>
      </div>
      {/* Main Content */}
      <div className="max-w-6xl mx-auto px-4 flex flex-col gap-10 items-center mt-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4 mt-2 text-gray-900 w-full text-left">Working at EGLO</h1>
        <div className="flex flex-col md:flex-row gap-4 w-full justify-center items-stretch mb-4">
          <div className="bg-teal-600 text-white rounded-lg shadow-md p-6 max-w-md w-full text-center text-base md:text-lg font-medium flex items-center justify-center">
            A good company can make your skills flourish.
          </div>
          <div className="bg-teal-600 text-white rounded-lg shadow-md p-6 max-w-2xl w-full text-center text-base md:text-lg font-medium flex items-center justify-center">
            Humans are organized beings. We organize ourselves in families, associations, institutions, companies and of course, we organize ourselves. We are in relationships with each other because we cannot exist alone. Only in exchange and in interaction with others can we develop and achieve things that we would not be able to do on our own. Therefore, we at EGLO highly value fair and performance-related cooperation.<br/><br/>We are convinced that everyone must contribute to creating a common, successful future. Inside and outside. Big and small.
          </div>
        </div>
