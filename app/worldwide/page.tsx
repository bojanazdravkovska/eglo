...
export default function WorldwidePage() {
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <h1 className="text-3xl md:text-4xl font-bold mb-4 mt-2 text-left px-4">EGLO worldwide</h1>
      <p className="text-lg md:text-xl text-left mb-6 px-4">If you want to conquer the world, you have to be everywhere.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {countries.map((c, idx) => (
          <div key={idx} className="break-inside-avoid bg-white rounded-lg shadow p-4 border border-gray-100">
            <div className="font-semibold text-teal-700 mb-1 uppercase text-sm">{c.country}</div>
            ...
            <div className="text-gray-700 text-sm mb-1">T: <span className="font-semibold">{c.phone}</span>{c.fax && <> | F: <span className="font-semibold">{c.fax}</span></>}</div>
